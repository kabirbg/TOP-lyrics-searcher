const sai =         ["#EE88AF", "#81C1CB"]
const trench =      ["#FCE300", "#595B3C"]
const blurryface =  ["#000000", "#8D0000"]
const vessel =      ["#E7E7E7", "#5A7696"]
const rab =         ["#3C68B2", "#BF3730"]
const selftitled =  ["#459861", "#97398B"]
const npi =         ["#8B706E", "#81876A"]
const heathens =    ["#A4EBA5", "#AA281C"]
const loc =         ["#61B8C1", "#667A96"]
const christmas =   ["#A4534C", "#31312E"]
